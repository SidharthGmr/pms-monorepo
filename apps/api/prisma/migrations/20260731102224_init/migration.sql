...
-- CreateIndex
CREATE INDEX "category_storeCode_parentId_idx" ON "category"("storeCode", "parentId");

-- CreateIndex
CREATE INDEX "category_storeCode_status_idx" ON "category"("storeCode", "status");

-- CreateIndex
CREATE INDEX "category_storeCode_displayOrder_idx" ON "category"("storeCode", "displayOrder");

-- CreateIndex
CREATE INDEX "category_storeCode_deletedAt_idx" ON "category"("storeCode", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "category_storeCode_id_key" ON "category"("storeCode", "id");

-- CreateIndex
CREATE UNIQUE INDEX "category_storeCode_name_key" ON "category"("storeCode", "name");

-- CreateIndex
CREATE INDEX "product_storeCode_status_idx" ON "product"("storeCode", "status");

-- CreateIndex
CREATE INDEX "product_storeCode_categoryId_idx" ON "product"("storeCode", "categoryId");

-- CreateIndex
CREATE INDEX "product_storeCode_brandNameId_idx" ON "product"("storeCode", "brandNameId");

-- CreateIndex
CREATE INDEX "product_storeCode_isFeatured_idx" ON "product"("storeCode", "isFeatured");

-- CreateIndex
CREATE INDEX "product_storeCode_deletedAt_idx" ON "product"("storeCode", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "product_storeCode_id_key" ON "product"("storeCode", "id");

-- CreateIndex
CREATE UNIQUE INDEX "product_storeCode_slug_key" ON "product"("storeCode", "slug");

-- CreateIndex
CREATE INDEX "ProductVariant_storeCode_productId_idx" ON "ProductVariant"("storeCode", "productId");

-- CreateIndex
CREATE INDEX "ProductVariant_storeCode_productId_isActive_idx" ON "ProductVariant"("storeCode", "productId", "isActive");

-- CreateIndex
CREATE INDEX "ProductVariant_storeCode_deletedAt_idx" ON "ProductVariant"("storeCode", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_storeCode_id_key" ON "ProductVariant"("storeCode", "id");

-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_storeCode_sku_key" ON "ProductVariant"("storeCode", "sku");

-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_storeCode_barcode_key" ON "ProductVariant"("storeCode", "barcode");

-- CreateIndex
CREATE INDEX "PriceHistory_storeCode_variantId_idx" ON "PriceHistory"("storeCode", "variantId");

-- CreateIndex
CREATE INDEX "PriceHistory_storeCode_variantId_effectiveFrom_idx" ON "PriceHistory"("storeCode", "variantId", "effectiveFrom");

-- CreateIndex
CREATE UNIQUE INDEX "PriceHistory_storeCode_variantId_effectiveFrom_key" ON "PriceHistory"("storeCode", "variantId", "effectiveFrom");
...
-- CreateIndex
CREATE INDEX "stockHistory_createdById_idx" ON "stockHistory"("createdById");
...
-- CreateIndex
CREATE UNIQUE INDEX "brandName_storeCode_id_key" ON "brandName"("storeCode", "id");
...
-- CreateIndex
CREATE UNIQUE INDEX "attribute_storeCode_id_key" ON "attribute"("storeCode", "id");
...
-- AddForeignKey
ALTER TABLE "category" ADD CONSTRAINT "category_storeCode_parentId_fkey" FOREIGN KEY ("storeCode", "parentId") REFERENCES "category"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "category" ADD CONSTRAINT "category_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "category" ADD CONSTRAINT "category_updatedById_fkey" FOREIGN KEY ("updatedById") REFERENCES "users"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "category" ADD CONSTRAINT "category_deletedById_fkey" FOREIGN KEY ("deletedById") REFERENCES "users"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_storeCode_categoryId_fkey" FOREIGN KEY ("storeCode", "categoryId") REFERENCES "category"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_storeCode_brandNameId_fkey" FOREIGN KEY ("storeCode", "brandNameId") REFERENCES "brandName"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_storeCode_attributeId_fkey" FOREIGN KEY ("storeCode", "attributeId") REFERENCES "attribute"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_storeCode_parentId_fkey" FOREIGN KEY ("storeCode", "parentId") REFERENCES "product"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_deletedById_fkey" FOREIGN KEY ("deletedById") REFERENCES "users"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductVariant" ADD CONSTRAINT "ProductVariant_storeCode_productId_fkey" FOREIGN KEY ("storeCode", "productId") REFERENCES "product"("storeCode", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProductVariant" ADD CONSTRAINT "ProductVariant_updatedById_fkey" FOREIGN KEY ("updatedById") REFERENCES "users"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductVariant" ADD CONSTRAINT "ProductVariant_deletedById_fkey" FOREIGN KEY ("deletedById") REFERENCES "users"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PriceHistory" ADD CONSTRAINT "PriceHistory_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "stockHistory" ADD CONSTRAINT "stockHistory_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
