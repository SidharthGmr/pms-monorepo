...
import { IProductPriceService } from '../services/interfaces/Iproduct-price.service';
...
import { IProductPriceRepository } from '../repository/interfaces/iproduct-price.repository';
...
import { ISupplierService } from '../services/interfaces/Isupplier.service';
...
container.bind<IProductPriceService>(TYPES.IProductPriceService).to(ProductPriceService);
...
container.bind<IProductPriceRepository>(TYPES.IProductPriceRepository).to(ProductPriceRepository);
