export const TYPES = {
  ...
  IProductPriceService: Symbol.for("ProductPriceService"),
  ...
  ProductPriceController: Symbol.for("ProductPriceController"),
  ...
  IProductPriceRepository: Symbol.for("ProductPriceRepository"),
